...
var clickeventtype = /*mobilecheck()*/ false ? 'touchstart' : 'click';
...
[].slice.call(document.querySelectorAll('.button--accept[data-stack = stack_iman]')).forEach(function (btn) { btn.addEventListener(clickeventtype, function() { iman.accept(buttonClickCallback.bind(this)); }); });
[].slice.call(document.querySelectorAll('.button--reject[data-stack = stack_iman]')).forEach(function (btn) { btn.addEventListener(clickeventtype, function() { iman.reject(buttonClickCallback.bind(this)); }); });
