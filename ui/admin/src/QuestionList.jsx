...
export default React.createClass({
    ...
    editEntity: function (entity) {
        hashHistory.push('/question/' + entity.id);
    },
    ...
    render: function () {
        ...
        return (
            <div>
                ...
                >
                    Are you sure you want to delete question { this.state.entity ? this.state.entity.title : '<unknown>' }?
                </Dialog>
