...
export default React.createClass({
    ...
    getInitialState: function () {
        return {
            entity: Stub.organizations.filter(c => c.id == this.props.params.id)
        };
    },

    saveEntity: function (entity) {
        Stub.organizations.push(entity);
    },
    ...
    render: function () {
        return (
            <EditEntity title="organization" entity={ this.state.entity } onSave={ this.saveEntity }>
                <TextField
